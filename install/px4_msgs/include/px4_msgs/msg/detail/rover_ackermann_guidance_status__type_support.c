...
static rosidl_typesupport_introspection_c__MessageMember RoverAckermannGuidanceStatus__rosidl_typesupport_introspection_c__RoverAckermannGuidanceStatus_message_member_array[5] = {
  {
    "timestamp",  // name
