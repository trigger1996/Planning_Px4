...
static rosidl_typesupport_introspection_c__MessageMember RoverDifferentialGuidanceStatus__rosidl_typesupport_introspection_c__RoverDifferentialGuidanceStatus_message_member_array[7] = {
  {
    "timestamp",  // name
